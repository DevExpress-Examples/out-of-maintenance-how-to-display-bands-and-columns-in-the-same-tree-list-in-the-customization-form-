...
Namespace TreeListCustomization
	...
	End Class
End Namespace
Namespace TreeListCustomization.CarsDBDataSetTableAdapters
	...
	Partial Public Class CarsTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`Trademark`, `Model`, `HP`, `Liter`, `Cyl`, `TransmissSpeedCo" & "unt`, `TransmissAutomatic`, `MPG_City`, `MPG_Highway`, `Category`, `Price`, `Des" & "cription`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Cars` SET `Trademark` = ?, `Model` = ?, `HP` = ?, `Liter` = ?, `Cyl` = ?, `TransmissSpeedCount` = ?, `TransmissAutomatic` = ?, `MPG_City` = ?, `MPG_Highway` = ?, `Category` = ?, `Price` = ?, `Description` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Trademark` IS NULL) OR (`Trademark` = ?)) AND ((? = 1 AND `Model` IS NULL) OR (`Model` = ?)) AND ((? = 1 AND `HP` IS NULL) OR (`HP` = ?)) AND ((? = 1 AND `Liter` IS NULL) OR (`Liter` = ?)) AND ((? = 1 AND `Cyl` IS NULL) OR (`Cyl` = ?)) AND ((? = 1 AND `TransmissSpeedCount` IS NULL) OR (`TransmissSpeedCount` = ?)) AND ((? = 1 AND `TransmissAutomatic` IS NULL) OR (`TransmissAutomatic` = ?)) AND ((? = 1 AND `MPG_City` IS NULL) OR (`MPG_City` = ?)) AND ((? = 1 AND `MPG_Highway` IS NULL) OR (`MPG_Highway` = ?)) AND ((? = 1 AND `Category` IS NULL) OR (`Category` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        ID, Trademark, Model, HP, Liter, Cyl, TransmissSpeedCount, Transmis" & "sAutomatic, MPG_City, MPG_Highway, Category, Price, Description" & Constants.vbCrLf & "FROM           " & " Cars"
		...
		Public Overridable Function Insert(ByVal Trademark As String, ByVal Model As String, ByVal HP? As Short, ByVal Liter? As Double, ByVal Cyl? As Byte, ByVal TransmissSpeedCount? As Byte, ByVal TransmissAutomatic As String, ByVal MPG_City? As Byte, ByVal MPG_Highway? As Byte, ByVal Category As String, ByVal Price? As Decimal, ByVal Description As String) As Integer
			...
			If (Price.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(10).Value = (CDec(Price.Value))
			Else
		...
		Public Overridable Function Update(ByVal Trademark As String, ByVal Model As String, ByVal HP? As Short, ByVal Liter? As Double, ByVal Cyl? As Byte, ByVal TransmissSpeedCount? As Byte, ByVal TransmissAutomatic As String, ByVal MPG_City? As Byte, ByVal MPG_Highway? As Byte, ByVal Category As String, ByVal Price? As Decimal, ByVal Description As String, ByVal Original_ID As Integer, ByVal Original_Trademark As String, ByVal Original_Model As String, ByVal Original_HP? As Short, ByVal Original_Liter? As Double, ByVal Original_Cyl? As Byte, ByVal Original_TransmissSpeedCount? As Byte, ByVal Original_TransmissAutomatic As String, ByVal Original_MPG_City? As Byte, ByVal Original_MPG_Highway? As Byte, ByVal Original_Category As String, ByVal Original_Price? As Decimal) As Integer
			...
			End If
			If (Price.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(10).Value = (CDec(Price.Value))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(14).Value = (CStr(Original_Trademark))
			End If
			If (Original_Model Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(16).Value = (CStr(Original_Model))
			End If
			If (Original_HP.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(17).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(18).Value = (CShort(Fix(Original_HP.Value)))
			Else
			...
			If (Original_Liter.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(20).Value = (CDbl(Original_Liter.Value))
			Else
			...
			If (Original_Cyl.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(22).Value = (CByte(Original_Cyl.Value))
			Else
			...
			If (Original_TransmissSpeedCount.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(24).Value = (CByte(Original_TransmissSpeedCount.Value))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(26).Value = (CStr(Original_TransmissAutomatic))
			End If
			If (Original_MPG_City.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(27).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(28).Value = (CByte(Original_MPG_City.Value))
			Else
			...
			If (Original_MPG_Highway.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(30).Value = (CByte(Original_MPG_Highway.Value))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(32).Value = (CStr(Original_Category))
			End If
			If (Original_Price.HasValue = True) Then
